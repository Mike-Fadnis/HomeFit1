...
import {Container,Header,Title,Content,Text,ListItem,CheckBox,Button,Icon,Footer,FooterTab,Left,Right,Body} from "native-base";
        ...
        API.trainerLogin(login).then(async (response) => {
           if (response.status === true){
            console.log("TRAINERUSERDTAAAA!@@@@: ", response);
              this.setState({userData:response.data,spinner:false},()=>{
